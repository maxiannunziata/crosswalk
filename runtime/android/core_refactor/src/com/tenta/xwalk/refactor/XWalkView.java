 ...
 * </p>
 * <ol>
 * <li>[To Be Deprecated] Set preference key {@link XWalkPreferences#ANIMATABLE_XWALK_VIEW}
 ...
 * XWalkPreferences#ANIMATABLE_XWALK_VIEW is invaild for this XWalkView. See below steps for
 * detail:
 * <ul type="disc">
 ...
 * {@link XWalkUIClient} for listening to the events related to resource loading and UI. By
...
//    })
    ...
    public void completeWindowCreation(XWalkView newXWalkView) {
...
//        }
     ...
     * "about:blank" if calling {@link XWalkView#getUrl()}. If content is null, try to load
     ...
     * @deprecated This method is deprecated, please use {@link XWalkView#loadUrl},
     ...
     * restriction, use {@link XWalkView#loadDataWithBaseURL} with an appropriate base URL.
     ...
     * {@link XWalkView#loadUrl(String)} instead. Note that the charset obtained from the
     ...
     * data scheme, this method is equivalent to calling {@link XWalkView#loadData} and the
